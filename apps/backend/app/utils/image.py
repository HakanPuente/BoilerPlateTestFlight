...
import io
"""
Pillow is an imaging library adds image processing capabilities to our Python interpreter.
We created helper functions to crop the image with 16 / 9 aspect ratio and return file object 
"""
SIZES = [
    (128, 128),
    (256, 256),
